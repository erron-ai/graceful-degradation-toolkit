"""Core logic for graceful_degradation_toolkit."""
...
def analyze_records(records: list[dict[str, Any]]) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        score=score,
        summary=f"{summary} result for: Middleware for agents to fail gracefully instead of looping at the 85-90% ceiling.",
        signals=signals,
    )
